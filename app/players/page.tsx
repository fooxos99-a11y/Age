...
export default function PlayersPage() {
  ...
  const playerIds = [
    13803227, 18269677, 16919033, 18127021, 14536691, 22697227, 720732, 18949649, 7202544, 22744507, 11831473, 17916129, 16735807, 22583412, 13610117, 24463802, 10838919, 23074017, 3104402, 15356403, 7751466, 8338970, 3830179, 10034848, 12612429, 16502579,
